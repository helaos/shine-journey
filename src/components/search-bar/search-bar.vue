...
import { formatMonthDay } from '@/utils/date-util'
// Props
...
const startDateFmt = computed(() => (formatMonthDay(startDate.value, "MM.DD")))
const endDateFmt = computed(() => (formatMonthDay(endDate.value, "MM.DD")))
  ...
  <div class="search">
    <div class="select-time">
      <div class="item start">
        ...
        <div class="date">{{ startDateFmt }}</div>
      </div>
      <div class="item end">
        <div class="name">离</div>
        <div class="date">{{ endDateFmt }}</div>
      </div>
    </div>
    <!-- 中间 -->
    <div class="content">
